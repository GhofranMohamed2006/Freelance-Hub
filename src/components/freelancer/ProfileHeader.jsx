      ...
      <div className="px-6 pb-6 pt-2 sm:px-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-3 pt-2 lg:pt-0">
            <button className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm cursor-pointer transition hover:bg-gray-50 hover:text-gray-900 sm:flex-initial">
              <FiCalendar className="text-gray-500" />
              Schedule Interview
            </button>

            <button className="flex flex-1 items-center justify-center rounded-xl bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm cursor-pointer transition hover:bg-indigo-700 sm:flex-initial">
              Hire Me
            </button>
          </div>
