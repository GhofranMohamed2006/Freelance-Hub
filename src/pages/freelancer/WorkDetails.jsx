...
import WorkDescription from "../../components/freelancer/work-details/WorkDetailsHeader";
  ...
  return (
    <div className="min-h-full bg-slate-50 px-4 py-6 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-7xl">
        <WorkDetailsHeader job={job} onBack={handleBack} />
        ...
        >
          <main className="space-y-6">
            <WorkDescription description={job.description} />
