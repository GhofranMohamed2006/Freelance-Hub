...
import { getFreelancerProject } from "../../api/freelancer.api.js";
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      try {
        const data = await getFreelancerProject(id);
        setProject(data);
      } catch (err) {
        setError(
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <Link to="/ongoingProjects" className="text-sm font-medium text-blue-700">
        ← Back to projects
      </Link>
