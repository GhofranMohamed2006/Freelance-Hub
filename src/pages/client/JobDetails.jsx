  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        await api.post(`/jobs/${jobId}/view`).catch(() => null);
      } catch (err) {
        setError(
      ...
      <article className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-slate-50 p-4">
            ...
            <p className="mt-2 text-xs text-slate-400">Budget</p>
          ...
          <div className="rounded-xl bg-slate-50 p-4">
            ...
            <p className="mt-2 text-xs text-slate-400">Views</p>
            <p className="font-semibold text-slate-800">{job.views || 0}</p>
          </div>
          <div className="rounded-xl bg-slate-50 p-4">
