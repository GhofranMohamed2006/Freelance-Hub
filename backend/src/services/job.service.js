...
const fields=["title","description","categoryId","category","skills","budget","budgetType","minBudget", "maxBudget", "hourlyRateMin","hourlyRateMax","projectDuration","experienceLevel", "duration", "attachments", "status","visibility"];
